...
namespace Real_Estate_Listing.Controllers
{
    ...
    {
        private readonly Real_Estate_ListingContext _context;

        public PropertiesController(Real_Estate_ListingContext context)
        {
            _context = context;
        }
        ...
        [HttpPut("sell/{id}")]
        public ActionResult<Property> SellProperty([FromRoute]int id, [FromBody] PropertySoldto propertySoldto)
        {
            ...
            property.SoldTo = propertySoldto.Name;
